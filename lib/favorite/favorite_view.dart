...
//                                     IconButton(
//                                         onPressed: () {
//                                           fav.items[index].fav = false;
//                                           TreeHelper().updateItem(
//                                               current, current.title);
//                                           fav.loadItemsFromDb(); // Refresh global items
//
//                                           //    fav.items.remove(current);
//                                         },
//                                         icon: Icon(
//                                           Icons.favorite,
//                                           color: Colors.red,
